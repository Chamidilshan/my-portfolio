      ...
      <div className='w-full md:w-1/2'>
        {emailSubmitted ? (
          ...
          <form className='flex flex-col' onSubmit={handleSubmit}>
            <div className='mb-6'>
              <label data-aos='fade-left' data-aos-duration='1000' htmlFor='email' className='text-white block mb-2 text-lg font-medium'>
                Your email
              </label>
              <input
                data-aos='fade-right'
            ...
            <div className='mb-6'>
              <label data-aos='fade-left' data-aos-duration='1000' htmlFor='subject' className='text-white block text-lg mb-2 font-medium'>
                Subject
              </label>
              <input
                data-aos='fade-right'
            ...
            <div className='mb-6'>
              <label data-aos='fade-left' data-aos-duration='1000' htmlFor='message' className='text-white block text-lg mb-2 font-medium'>
                Message
              </label>
              <textarea
                data-aos='fade-right'
