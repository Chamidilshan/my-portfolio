export const Bio = {
  ...
  export const experiences = [
    ...
    },
    {
      ...
      desc: "I completed two projects using Flutter and clean architecture: a gym app called Nerva and an inventory management app called Inventra. As the sole Flutter developer on both projects, I had the opportunity to gain real-world experience. I crafted beautiful UIs and implemented API calls  for both apps getting new expereinces. I successfully completed the Inventra app and handed it over to the client for testing. I managed this internship while juggling my academic responsibilities.",
      skills: [
        "Flutter",
        "Firebase",
        "Postman",
  ...
  export const education = [
    ...
    },
    {
      ...
      desc: "I completed my Adavanced Level at D.S.Senanayake National School in Physial Science Stream(Chemistry, Combined Mathematics, Physics)",
      degree: "D.S.Senanayake National School, Ampara",
    },
    {
      id: 2,
      img: "https://dssca.online/wp-content/uploads/2023/09/DSLG_FB.png",
      ...
      date: "2011 - 2016",
      grade: "9 \"A\"s",
      desc: "I completed my Oridnary Level Exam at D.S.Senanayake National School with all \"A\" passes for all 9 subjects.",
      degree: "D.S.Senanayake National School, Ampara",
    },
  ];
  ...
  export const projects = [
    ...
    {
      id: 2,
      title: "SL Explorer Dashboard",
      date: "Jan 2023 - Present", 
      description:
      "I developed an admin dashboard for SL Explorer using React,Node,MongoDB offering administrators and users the ability to manage hotels, packages, and company details seamlessly. Also implemented a web-based dashboard for push notification management, integrating MongoDB for data storage and Firebase for user authentication.",
      image: 
        "https://github.com/Chamidilshan/my-portfolio/assets/89196733/41cddfca-4b30-475b-b32f-42c41267264b",
      tags: ["React.js", "Node.js", "MongoDB", "Materail UI", "Firebase"],
